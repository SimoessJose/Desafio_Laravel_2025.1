<x-app-layout>
    <x-slot name="header">
        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tabela de Gerenciamento de Usuários') . " : " . \Auth::guard('admin')->user()->name }}
        </h2>
    </x-slot>

    <!-- Envolva sua tabela em um container Alpine para armazenar o ID do usuário a ser deletado -->
                        ...
                        <table class="min-w-full divide-y divide-gray-200 overflow-x-auto">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th>
                                        <a href="{{ route('createProfile') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">+</a>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
            <form method="post" x-bind:action="'{{ url('/delete') }}/' + deleteUserId" class="p-6">
                ...
                <div class="mt-6 flex justify-end">
                    <button type="button" class="mr-4 text-gray-600 hover:text-gray-900" x-on:click="$dispatch('close')">Cancel</button>
