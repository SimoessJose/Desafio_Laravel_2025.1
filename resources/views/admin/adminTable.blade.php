                                ...
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th
                                            ...
                                            Actions</th>
                                        <th>
                                            <a href="{{ route('createAdminProfile') }}"
                                    ...
                                    @foreach($admins as $admin)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-wrap text-sm font-medium gap-20">
                                                <a href="{{ route('viewAdminProfile', $admin->id) }}"
                                                    class="ml-2 text-green-600 hover:text-green-900">View</a>
                                                <a href="{{ route('editAdminProfile', $admin->id) }}"
            ...
            <form method="post" x-bind:action="'{{ route('deleteAdmin', '') }}/' + deleteAdminId" class="p-6">
                ...
                <div class="mt-6 flex justify-end">
                    <button type="button" class="mr-4 text-gray-600 hover:text-gray-900"
                        x-on:click="$dispatch('close')">Cancelar</button>
                    <button type="submit"
                        class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">Deletar</button>
                </div>
            </form>
        </x-modal>
    </div>
